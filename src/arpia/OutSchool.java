...
public class OutSchool extends JFrame {
  ...
  OutSchool() {
    ...
    setContentPane(new JLabel(new ImageIcon("./src/arpia/img/background/학교 지도 2.png")));
      ...
      public void keyPressed(KeyEvent e) {
        switch (e.getKeyCode()) {
          case KeyEvent.VK_UP:
            ...
            character_Label.setLocation(character_Label.getX(), character_Label.getY() - 10);
            break;
          ...
          case KeyEvent.VK_LEFT:
            character_Label.setIcon(Player.getLeftimage());
            character_Label.setLocation(character_Label.getX() - 10, character_Label.getY());
            break;
